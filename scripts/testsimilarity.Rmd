...
S = seq(from=max(0, round(21-3-max(chr2.all.D)/2)), to=round(217-3-min(chr2.all.D)/2), by=1)
...
S = seq(from=max(0, round(217-3-max(chrC.all.D)/2)), to=round(217-3-min(chrC.all.D)/2), by=1)
lines(x=I(2*(217-3-S)), y=dpois(S, lambda=1/8), lwd=2)
...
# for chromosome M
plot(h1, main="Distance density for Chr. M with all blocks", xlab="Chromosome M", col=rgb(1,0,0,0.2), freq=FALSE, breaks=10)
S = seq(from=max(0, round(217-3-max(chrM.all.D)/2)), to=round(217-3-min(chrM.all.D)/2), by=1)
lines(x=I(2*(217-3-S)), y=dpois(S, lambda=1/8), lwd=2)
...
S = seq(from=max(0, round(217-3-max(chr2.cnsc.D)/2)), to=round(217-3-min(chr2.cnsc.D)/2), by=1)
lines(x=I(2*(217-3-S)), y=dpois(S, lambda=1/8), lwd=2)
...
S = seq(from=max(0, round(217-3-max(chrC.cnsc.D)/2)), to=round(217-3-min(chrC.cnsc.D)/2), by=1)
lines(x=I(2*(217-3-S)), y=dpois(S, lambda=1/8), lwd=2)
...
# for chromosome M
plot(h2, main="Distance density for Chr. M with consec. blocks", xlab="Chromosome M", col=rgb(1,0,0,0.2), freq=FALSE, breaks=10)
S = seq(from=max(0, round(217-3-max(chrM.cnsc.D)/2)), to=round(217-3-min(chrM.cnsc.D)/2), by=1)
lines(x=I(2*(217-3-S)), y=dpois(S, lambda=1/8), lwd=2)
